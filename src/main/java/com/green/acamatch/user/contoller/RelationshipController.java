...
public class RelationshipController {
    ...
    @GetMapping("required")
    @Operation(summary = "요청 조회",description = "부모가 자식한테서 관계 등록 요청이 들어 왔는지 조회")
    ...
    @Operation(summary = "요청 승인", description = "부모가 자식한테서 온 관계 등록 요청 승인")
    ...
    @PostMapping
    @Operation(summary = "요청", description = "자식이 부모의 이메일로 관계 등록 요청")
    ...
    @DeleteMapping
    @Operation(summary = "요청 삭제", description = "자식이 부모의 이메일로 관계 등록 요청 취소</br>승인 전까지만 가능")
