...
public class Oauth2AuthenticationRequestBasedOnCookieRepository
    ...
    public void removeAuthorizationCookies(HttpServletResponse response) {
        cookieUtils.deleteCookieToken(response, globalOauth2.getAuthorizationRequestCookieName());
        cookieUtils.deleteCookieToken(response, globalOauth2.getRedirectUriParamCookieName());
    }
}
